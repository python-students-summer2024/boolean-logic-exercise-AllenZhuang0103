...
def is_sweltering():
    ...
    return float(input("What is the temperature in Farenheit now? ")) > 90
...
def is_warm():
    ...
    """
    # write your code for this function below this line.
    return 75 <= float(input("What is the temperature in Farenheit now? ")) <= 87
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    return "yes" == input("Is it currently humid? ").lower() 
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    return input("What is the weather forecast today? ").lower() in ["rain", "snow", "sleet"]
